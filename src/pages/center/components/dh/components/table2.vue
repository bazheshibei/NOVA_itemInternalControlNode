...
export default {
  ...
  methods: {
    ...
    clickSearch() {
      ...
      this.$store.commit('saveData', { name: 'node_name', obj: node_name, module: 'Dh' })
      this.$store.commit('saveData', { name: 'status', obj: status, module: 'Dh' })
      /** 刷新 **/
      this.f5(true)
    },
    /**
    ...
    clickReset() {
      this.node_name = ''
      this.status = ''
      this.$store.commit('saveData', { name: 'node_name', obj: '', module: 'Dh' })
      this.$store.commit('saveData', { name: 'status', obj: '', module: 'Dh' })
      /** 刷新 **/
      this.f5(true)
    },
    /**
    ...
    f5(reset = true) {
      if (reset) {
        ...
        this.$store.commit('assignData', { name: 'pageObj', obj: pageObj, module: 'Dh' })
      }
      this.choiceRow = {}
      /** 发起请求 **/
      this._request()
